...
@section('content')
    ...
    <div class="row">
        <div class="col">
            ...
            <input class="form-control" type="text" placeholder="abcnews" id="handle">
        </div>
        <div class="col">
            <label>Avatar</label>
            <input class="form-control" type="url" value="https://pbs.twimg.com/profile_images/1034589406005317632/Cdi3F2ro_400x400.jpg" id="avatar">
        </div>
    </div>
    <br/>
    <div class="row">
    ...
    <a href="{{route('admim.pasttweets')}}">Past Tweets</a>
@endsection