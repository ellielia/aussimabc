        ...
        <ul>
            <li class="breaking lines-1 show-ticker"><ul>
                    <li style="opacity: 1;"><div class="ticker-type">Breaking news</div>
                        <a href="{{config('app.breakingnewsurl')}}" target="_self" title="">{{config('app.breakingnewstext')}}</a></li>
                </ul>
            </li>
        </ul>
    </div>
                    ...
                    <div class="c16l">
                        <div class="section">
                            ...
                            <ul class="nav">
                                ...
                                @php
                                $articleCategories = \App\ArticleCategory::all();
                                @endphp
...
<!-- End ABC MyLogin -->
<!--endnoindex-->
<!-- End ABC Bundled Footer 2.4.0 (customised - p1) -->
<!--end global footer-->
</body>
</html>